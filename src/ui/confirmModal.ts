...
export class ConfirmModal extends Modal {
  ...
  onOpen(): void {
    ...
    contentEl.empty();
    contentEl.addClass("about-blank-confirm-modal");

    contentEl.createEl("h3", { text: this.options.title });
    contentEl.createEl("p", {
      cls: "about-blank-confirm-modal-message",
      text: this.options.message,
    });

    const actionsEl = contentEl.createDiv({ cls: "about-blank-confirm-modal-actions" });
